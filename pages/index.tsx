...
export default function Home() {
  ...
  const [currentFile, setCurrentFile] = useState<dataType>(null);
  ...
  const [isMp4Res, setIsMp4Res] = useState<boolean>(false);

  const uploadToClient = (event: { target: { files: FileList | null } }) => {
    if (event.target.files && event.target.files[0]) {
      const acceptedImageTypes = ['image/png', 'image/webp', 'image/jpg', 'image/jpeg', 'image/gif', 'video/mp4']
  ...
  const uploadToServer = async (event: any) => {
    ...
    axios.post('/api/upload', body, {
      ...
      if (resp.status === 201) {
        ...
        if ((resp.data.fileName as string).includes('.mp4')) {
          setIsMp4Res(true)
        }
        else {
          setIsMp4Res(false)
      ...
      <main className='h-screen'>
        <div className='w-full h-full bg-[url(/yuki.png)] bg-cover'>
          ...
          <div className='flex justify-center'>
            <div className='rounded-xl w-11/12 sm:w-5/6 md:w-2/3 lg:w-2/3 2xl:w-1/3 border-2 border-stone-800 bg-zinc-800/80'>
              <div className='rounded-t-lg relative'>
                ...
                <div className='rounded-t-lg w-full z-1'>
                  ...
                  <div className='flex justify-center items-center'>
                    ...
                    <p className='text-xl font-bold text-neutral-200'>&nbsp;&nbsp;โยนไฟล์ jpg/png/gif/webp/mp4 ใส่ตรงนี้</p>
                  </div>
                        ...
                        isMp4 ?
                          <>
                            <video width="320" height="240" autoPlay loop muted>
                              <source src={createObjectURL} type="video/mp4" />
                            </video>
                          </> :
                          <>
                ...
                <div className='flex justify-center mt-2 mb-1'>
                  {
                    isMp4Res ?
                      <>
                        <video width="320" height="240" autoPlay loop muted>
                          <source src={"/api/download/" + imageOutURL.fileName} type="video/mp4" />
                        </video>
                      </> :
                      <>
